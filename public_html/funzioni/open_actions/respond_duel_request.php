...
$id_duel_request = isset($_POST['id_duel_request']) ? (int) $_POST['id_duel_request'] : 0;
...
if ($id_user_ig <= 0 || $id_duel_request <= 0)
{
    echo json_encode([
        'stato' => 'KO',
        'msg' => 'INVALID_REQUEST',
...
try
{
    $result = animaster_pvp_respond_request($conn, $id_user_ig, $id_duel_request, $accept === 'S', $lang_suffix);
}
catch (Throwable $e)
{
    error_log('[respond_duel_request] ' . $e->getMessage());
    echo json_encode([
        'stato' => 'KO',
        'msg' => 'SERVER_ERROR',
        'response' => ''
